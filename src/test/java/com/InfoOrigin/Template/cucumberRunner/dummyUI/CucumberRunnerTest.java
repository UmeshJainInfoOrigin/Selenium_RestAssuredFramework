package com.InfoOrigin.Template.cucumberRunner.dummyUI;
...
@CucumberOptions(
        features = "src/test/java/com/InfoOrigin/Template/features", glue = "com/InfoOrigin/Template/stepDefinitions",
